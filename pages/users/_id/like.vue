            ...
            <div class="row">
                <div class="col-8 main">
                    ...
                    <ul class="trigger-menu">
                        ...
                        <li :class="{active:currentTab == 'LikeAtrice'}">
                            <a href="javascript:void(0)" @click="toggleTab('LikeAtrice')">
...
<script>
    ...
    import LikeAtrice from '~/components/users/LikeAtrice'
    export default {
        name:'',
        data () {
            return {
                currentTab:'LikeAtrice',
                followObj: {
                    'follow': true,
                    'following': false
                },
