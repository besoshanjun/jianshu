            ...
            <div class="row">
                            ...
                            <li class="have-img">
                                ...
                                <div class="content">
                                    <div class="author">
                                        ...
                                        <div class="info">
                                            <nuxt-link to="/u/123" class="nickname">萌薇</nuxt-link>
                ...
                <div class="col-4 aside">
                    <div class="board">
                        ...
                        <nuxt-link to=".">
                            <img src="../assets/img/right-2.png">
                        </nuxt-link>
                        <nuxt-link to=".">
                            <img src="../assets/img/right-3.png">
                        </nuxt-link>
                        <nuxt-link to=".">
                            <img src="../assets/img/right-4.png">
                        </nuxt-link>
                        <nuxt-link to=".">
                            <img src="../assets/img/right-5.png">
                        </nuxt-link>
                    </div>
                    <div class="download">
            ...
            <div class="row">
                <div class="col-9">
                   <ul class="list">
                    ...
                    <div class="jiesao">
                        ©2012-2018 上海佰集信息科技有限公司 / 简书 / 沪ICP备11018329号-5 / &x3000:;
    ...
    export default{
            ...
            return {
                ...
                swiperOption: {
                    ...
                    autoplay: {
                        ...
                        disableOnOnteraction: false//禁止轮播
                    },
                    pagination: {
        ...
        methods:{
            rotate:function () {
                ...
                let deg = this.$refs.refresh.style
